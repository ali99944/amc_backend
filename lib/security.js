...
import { admin_web_token_key, json_web_token_expires_in, user_json_web_token_key } from './configs.js'
 ...
 */
export const verifyUserToken = (token) => jwt.verify(token, user_json_web_token_key)
